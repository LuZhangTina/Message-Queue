 ...
 */
public class InFileQueueServiceTest {
    private InFileQueueService fileQueueService;
    @Before
    public void runPreCondition() {
        this.fileQueueService = new InFileQueueService();
    }
    ...
    public void testPushThreeMessages() {
        boolean result = fileQueueService.push("https://sqs.us-east-2.amazonaws.com/123456789012/MyQueue1", 2, "hello", "world", "java");
        Assert.assertTrue(result);
    }
    ...
    public void testPushMessagesToThreeQueues() {
        ...
        result = fileQueueService.push("https://sqs.us-east-2.amazonaws.com/123456789012/MyQueue2", 2, "apple", "banana", "orange");
        Assert.assertTrue(result);

        result = fileQueueService.push("https://sqs.us-east-2.amazonaws.com/123456789012/MyQueue3", 2, "car", "bus", "train");
        Assert.assertTrue(result);
    }
    ...
    public void testDeleteMessageInVisibleTimeout() {
        boolean result = fileQueueService.push("https://sqs.us-east-2.amazonaws.com/123456789012/MyQueue1", 0, "hello", "world", "java");
        Assert.assertTrue(result);

        Message message1FromQueue = fileQueueService.pull("https://sqs.us-east-2.amazonaws.com/123456789012/MyQueue1");
        Assert.assertEquals("hello", message1FromQueue.getData());

        Assert.assertTrue(fileQueueService.delete("https://sqs.us-east-2.amazonaws.com/123456789012/MyQueue1", message1FromQueue.getMessageId()));
        ...
        Assert.assertTrue(fileQueueService.delete("https://sqs.us-east-2.amazonaws.com/123456789012/MyQueue1", message3FromQueue.getMessageId()));

        /** Mock timer triggers the run method */
        InFileQueue queue = fileQueueService.getInFileQueue("MyQueue1");
        queue.updateMessageIntoVisibleState();

        Assert.assertFalse(fileQueueService.delete("https://sqs.us-east-2.amazonaws.com/123456789012/MyQueue1", message2FromQueue.getMessageId()));
